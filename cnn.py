...
class network:
    """
    Class build required network based on input
    ...
    def conv2d_layer(self,layer_specs,layer_input):
        """
        Function creates convolution layers with keras

        args:
            layer_specs: Dictionary of layer specifications
        """
        
        filters = layer_specs['filters']
        kernel_size = layer_specs['kernel_size']
        strides = layer_specs['strides']
        padding = layer_specs['padding']
        data_format = layer_specs['data_format']
        dilation_rate = layer_specs['dilation_rate']
        ...
        kernel_regularizer = layer_specs['kernel_regularizer']
        bias_regularizer = layer_specs['bias_regularizer']
        activity_regularizer = layer_specs['activity_regularizer']
        kernel_constraint = layer_specs['kernel_constraint']
        bias_constraint = layer_specs['bias_constraint']

        conv_out = tf.keras.layers.Conv2D(filters,kernel_size,strides,padding,
                                        data_format,dilation_rate,activation,
                                        use_bias,kernel_initializer,bias_initializer,
                                        kernel_regularizer,bias_regularizer,activity_regularizer,
                                        kernel_constraint,bias_constraint,layer_input)
        return conv_out

    def dqn(self,conv_layer_specifications,fc_layer_specifications):
                """
        Function creates a Q-network

        args:
            conv_layer_specifications: Dictionary. Contains requirements to create convolution layers
            fc_layer_specifications:  Dictionary. Contains requirements to create fc layers
        """

        

    def conv_layer(self,m_input,size_in,size_out,k_size_w,k_size_h,conv_stride,pool_k_size,pool_stride_size,trainable_vars,name,num):
        """
    ...
    def fc_layer(self,m_input,size_in,size_out,trainable_vars,name,num):
        """
        Creates convolution Layer
    ...
    def final_linear_layer(self,m_input,size_in,size_out,trainable_vars,name="final",num="1"):
    ...
    def build_graph(self,name,net_in,conv_count,fc_count,conv_feats,fc_feats,conv_k_size,conv_stride,trainable_vars):
        """
    ...
    def build_update_infer_weights_op(self,conv_name,fc_name,conv_count,fc_count):
        """
    ...
    def infer_weight_update_ops(self,conv_name,fc_name,conv_count,fc_count):
        """
        Function builds operations for updating weights of inference graph
    ...
    def get_all_weights_bias_tensors(self,conv_count,fc_count):
        """
    ...
    def target_weight_update_ops(self,conv_name,fc_name,conv_count,fc_count):
        """
    ...
    def create_model(self,learning_rate,gamma,batch_size,conv_count,fc_count,conv_feats,fc_feats,conv_k_size,conv_stride,LOGDIR):
        """
    ...
    def construct_two_network_model(self,learning_rate,gamma,batch_size,seq_len,conv_count,fc_count,conv_feats,fc_feats,conv_k_size,conv_stride,LOGDIR):
        """
    ...
    def create_model2(self,learning_rate,gamma,batch_size,conv_count,fc_count,conv_feats,fc_feats,conv_k_size,conv_stride,LOGDIR):
        """
    ...
    def infer_model(self,learning_rate,batch_size,conv_count,fc_count,conv_feats,fc_feats,conv_k_size,conv_stride,LOGDIR):
        """
    ...
    def train_model(self,learning_rate,batch_size,conv_count,fc_count,conv_feats,fc_feats,conv_k_size,conv_stride,LOGDIR):
        """
    ...
    def flatten_weights_summarize(self,w,num,trainable):
        """
    ...
    def intermediate_summary_img(self,img,num,trainable):
        s_img = img[0,:,:,:]
        if (trainable):
